...
// Careful when adding a new color, the under are generated using the Material Theme Builder. Should be switchable easily
...
val md_theme_dark_inversePrimary = Color(0xFF1360A5)
